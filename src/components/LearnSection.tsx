...
const LearnSection = (): JSX.Element => {
  ...
  return (
    <section className="text-center flex flex-col gap-20 max-[767px]:py-10 max-[767px]:px-5 px-25 py-20">
      ...
      <img src={map_image} alt="A map" className="min-[767px]:h-150 object-cover w-full"/>
